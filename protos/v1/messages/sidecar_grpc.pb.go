...
type SidecarClient interface {
	...
	PubJS(ctx context.Context, in *PubJSMsg, opts ...grpc.CallOption) (*empty.Empty, error)
	Log(ctx context.Context, in *LogMsg, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *sidecarClient) PubJS(ctx context.Context, in *PubJSMsg, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *sidecarClient) Log(ctx context.Context, in *LogMsg, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type SidecarServer interface {
	...
	PubJS(context.Context, *PubJSMsg) (*empty.Empty, error)
	Log(context.Context, *LogMsg) (*empty.Empty, error)
...
func (UnimplementedSidecarServer) PubJS(context.Context, *PubJSMsg) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PubJS not implemented")
}
func (UnimplementedSidecarServer) Log(context.Context, *LogMsg) (*empty.Empty, error) {
